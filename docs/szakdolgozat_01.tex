...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.5\textwidth]{use_case_local_game}
	\end{center}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.5\textwidth]{use_case_network_game}
	\end{center}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.5\textwidth]{use_case_playback}
	\end{center}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.5\textwidth]{modules}
	\end{center}
...
\begin{figure}[b]
	\begin{center}
		\includegraphics[width=0.5\textwidth]{controller}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=0.5\textwidth]{legacy}
	\end{center}
...
\begin{thebibliography}{CMake}
	...
	\bibitem[SM]{smart} SMART criteria, Wikipedia, en.wikipedia.org/wiki/SMART\_criteria, 2015.01.15.
	
	\bibitem[Zold]{zold} Uray Marcell János: A sakk szabályai, Zöld Sakk, zoldsakk.hu/rules.php, 2015.04.10.
\end{thebibliography}
